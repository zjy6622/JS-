...
setMaxDigits(129);
////////////////////////
//RSAKeyPair的参数是在html中执行的js函数，需从https://passport.fang.com/?backurl=https%3A%2F%2Fhf.fang.com%2F中获取
function encryptRsa(t){
    ...
    return encryptedString(key_to_encode, t)
};
